...
class SymbolRing:
    ...
    def move(self, steps, direction):
        ...
        saved position with the new value. The stepper is released when the move completes.
    ...
    def release(self):
        ...
        """
        sleep(0.4)
        release_stepper = getattr(self.stargate.electronics, "release_stepper", None)
        if release_stepper:
            release_stepper()
            return
