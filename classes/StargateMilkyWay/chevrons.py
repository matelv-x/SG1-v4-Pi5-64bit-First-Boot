...
class Chevron:
    ...
    def __init__(self, electronics, chevron_number, audio, cfg):
        ...
        self.chevron_down_servo_throttle = -0.5
        ...
        self.chevron_up_servo_throttle = 0.7
        ...
        self.motor_is_servo = getattr(self.motor, "is_servo_adapter", False) or "servo" in str(type(self.motor)).lower()
    ...
    def move_down(self):
        ...
        throttle = self.chevron_down_servo_throttle if self.motor_is_servo else self.chevron_down_throttle
        self.motor.throttle = throttle # Start the motor
    ...
    def move_up(self):
        ...
        throttle = self.chevron_up_servo_throttle if self.motor_is_servo else self.chevron_up_throttle
        self.motor.throttle = throttle # Start the motor
