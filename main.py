...
if GALAXY == "Milky Way":
    sys.path.append(os.path.join(BASE_DIR, 'classes/StargateMilkyWay'))
...
class GateApplication:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.httpd_server = ThreadingHTTPServer(('', self.cfg.get("control_api_server_port")), StargateWebServer)
